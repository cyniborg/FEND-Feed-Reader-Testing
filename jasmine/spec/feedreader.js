...
$(function() {
  ...
  describe('RSS Feeds', function() {
     ...
     */
    it('has all feeds named and is not empty', function() {
      allFeeds.forEach(function(feed) {
  ...
  describe('The menu', function() {
    ...
    it('is hidden when clicked while visible', function() {
      $('a.menu-icon-link').trigger('click');
      expect($('.menu-hidden').is(':visible')).toBe(true);
    });
  ...
  describe('Initial Entries', function() {
    ...
    it('is called and completes its work', function(done) {
  ...
  describe('New Feed Selection', function() {
    ...
    beforeEach(function(done) {
      loadFeed(0, function() {
        feedTest = $('.feed').find('h2')[0].innerText;
        done();
      });
    });
    it('has changing content loaded by the loadFeed function', function(done) {
      // Load new feed
      loadFeed(1, function() {
